    ...
    <div className="md:hidden">
      ...
      {screen == 0 && (
        <div className="bg-[#F3F4F6] md:hidden grid grid-cols-8 grid-rows-10 w-full h-full">
          ...
          <div
            ...
            className={`p-4 ${getColorByRoomType('OC')} col-span-3 col-start-6 row-span-4 flex items-center justify-center border-2 border-slate-600`}
          >
      ...
      <div className="w-full bg-[#F3F4F6]">
        ...
        {screen == 2 && (
          <div className="flex flex-col items-center justify-center">
            {data
              .filter((item) => item.floor_id == 8 && item.direction == "M")
              .map((item, index) => (
                <div
                  key={index}
                  className={`w-3/4 h-16 flex flex-col items-center justify-center ${getColorByRoomType(
      ...
      <div className="my-4">
        {screen != 0 && <Legend data={data} floor={"E"} />}
      </div>
    </div>
  );
};

export default FloorERes;
