          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex md:gap-3">
              <button
                ...
                className="bg-gray-100 dark:bg-[#2E236C] text-gray-800 dark:text-white px-4 py-2 rounded-md text-sm font-medium mr-2"
              >
                Log In
              </button>
              <button
                onClick={handleDialogSignUpToggle}
                className="bg-black dark:bg-white text-white dark:text-[#2E236C] px-4 py-2 rounded-md text-sm font-medium"
              >
                Sign Up
              </button>
            </div>
